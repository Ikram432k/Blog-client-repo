...
const Home =(user:userName)=>{
    ...
    return(
        <div className="posts">
            <div className="top" >
                <p className="cmticon">
                    Post your own views and perspectives as blog by signing up <Link to='/signup'><span className="material-symbols-outlined">login</span></Link> or <Link to='/login'> <span className="material-symbols-outlined">logout</span> loging in</Link>.
                </p>
            </div>
            <div className="main">
                {post.map((obj,i)=>(
