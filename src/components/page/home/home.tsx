...
const Home =(user:userName)=>{
    ...
    return(
        <div className="posts">
            <div className="top" >
                <p>
                    Post your own views and perspectives as blog by signing up <Link to='/signup'>signing up <span className="material-symbols-outlined">login</span>signup</Link> or <Link to='/login'>loging in <span className="material-symbols-outlined">logout</span></Link>.
                </p>
            </div>
            <div className="main">
                {post.map((obj,i)=>(
